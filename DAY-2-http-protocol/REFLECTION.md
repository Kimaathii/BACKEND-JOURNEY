...
## Challenges I Faced
[ the concept of arrange logic to checking urls and methods...... learn that the url check approach mitigate repetition in checks]

## What I Learned
1. assigning status code to responds
2. logic to getting id, url and method from request
3. how to handle all types of http methods, GET, POST, PUT, PATCH and DELETE

## Questions Still Unclear
[not yet i did try to manipulate things later]
